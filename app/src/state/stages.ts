...
export const STAGES: StageConfig[] = [
  ...
  { id: 'feature_challenge',       label: '2.1 Feature Challenge',        expectedCardType: 'transformation_handle', order: 10, moduleId: 'feature_challenge', bg: 'bg-violet-50',  border: 'border-violet-400', text: 'text-violet-700' },
