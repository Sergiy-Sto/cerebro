...
massert "создал страницу + скрин, дизайн НЕ оценён → дизайн-нудж" 2
{ user_block; printf '\n'; browse; printf '\n'; ss_block; printf '\n'; claim 'Создал страницу, оценил дизайн: воздух и баланс ок.'; } > "$TMP"
massert "создал страницу + скрин + дизайн оценён → не нудж" 0
